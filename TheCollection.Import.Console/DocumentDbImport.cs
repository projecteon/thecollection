namespace TheCollection.Import.Console {
    ...
    public class DocumentDbImport {
        public static async System.Threading.Tasks.Task<IList<Brand>> ImportBrandsAsync(DocumentClient client, List<Merk> meerken)
        {
            ...
            var brandsRepository = new CreateRepository<Brand>(client, DocumentDB.DatabaseId, DocumentDB.Collections.Brands);
            var insertCounter = 0;
        ...
        public static async System.Threading.Tasks.Task<IEnumerable<Bag>> ImportBagsAsync(DocumentClient client, List<Thee> thees, IList<Brand> brands)
        {
            ...
            var bagsRepository = new CreateRepository<Bag>(client, DocumentDB.DatabaseId, DocumentDB.Collections.Bags);
        ...
        private static async System.Threading.Tasks.Task<List<Country>> ImportCountriesAsync(DocumentClient client, List<Thee> thees)
        {
            ...
            var countryRepository = new CreateRepository<Country>(client, DocumentDB.DatabaseId, DocumentDB.Collections.Countries);
            var insertCounter = 0;
        ...
        private static async System.Threading.Tasks.Task<List<BagType>> ImportBagTypesAsync(DocumentClient client, List<Thee> thees)
        {
            ...
            var bagTypeRepository = new CreateRepository<BagType>(client, DocumentDB.DatabaseId, DocumentDB.Collections.BagTypes);
            var insertCounter = 0;
        ...
        private static async System.Threading.Tasks.Task<List<Image>> ImportImagesAsync(DocumentClient client, List<Thee> thees)
        {
            ...
            var imageRepository = new CreateRepository<Image>(client, DocumentDB.DatabaseId, DocumentDB.Collections.Images);
            var insertCounter = 0;
        ...
        {
            var bagsRepository = new SearchRepository<Bag>(client, DocumentDB.DatabaseId, DocumentDB.Collections.Bags);
            var updateBagsRepository = new UpdateRepository<Bag>(client, DocumentDB.DatabaseId, DocumentDB.Collections.Bags);
